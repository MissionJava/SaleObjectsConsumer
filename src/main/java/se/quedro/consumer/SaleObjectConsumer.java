...
public interface SaleObjectConsumer {
     ...
     */
    PriorityOrderAttribute getPriorityOrderAttribute(String priorityOrderAttribute);
     ...
     *  @throws se.quedro.exceptions.TechnicalException if any problem occurs during the invocation resulting in the object not being reported successfully.
     */
    ...
    default boolean isTransactionCommitted() {
        return false;
    }
}
